<template>
  <div>
    <BasicTable @register="registerTable" :searchInfo="searchInfo">
      <template #toolbar>
        <a-button type="primary" @click="handleCreate">新增实战操盘</a-button>
      </template>
...
<script lang="ts">
  ...
  import { actualCombatDel, actualCombatList } from '/@/api/demo/home';
    ...
    setup() {
      ...
      function handleDelete(record: Recordable) {
        Modal.confirm({
          ...
          content: '你将删除当前实战操盘信息，你还要继续吗？',
          okText: '继续',
          cancelText: '取消',
          onOk() {
            actualCombatDel({ id: record.id }).then(() => {
