<template>
  <div>
    <BasicTable @register="registerTable" :searchInfo="searchInfo">
      <template #toolbar>
        <a-button type="primary" @click="handleCreate">新增系统课程</a-button>
      </template>
...
<script lang="ts">
  ...
  import { courseDel, courseList } from '/@/api/demo/home';
    ...
    setup() {
      ...
      function handleDelete(record: Recordable) {
        Modal.confirm({
          ...
          content: '你将删除当前系统课程信息，你还要继续吗？',
          okText: '继续',
          cancelText: '取消',
          onOk() {
            courseDel({ id: record.id }).then(() => {
